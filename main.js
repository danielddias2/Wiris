...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Fechar o menu mobile após qualquer clique em um link.
  // O menu é gerado dinamicamente por buildNav(), então o listener
  // precisa ser delegado depois que os links existem.
  ...
  // Navegação determinística: somente os seis destinos oficiais.
  // Impede qualquer comportamento externo de alterar o alvo do link.
